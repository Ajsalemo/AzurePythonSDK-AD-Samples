...
This example gets a Service Principal through this API's endpoint - [Get a Service Principal](https://docs.microsoft.com/en-us/graph/api/serviceprincipal-get?view=graph-rest-1.0&tabs=http)
...
- Create and activate your virtual environment and run `get-service-principal.py`.
