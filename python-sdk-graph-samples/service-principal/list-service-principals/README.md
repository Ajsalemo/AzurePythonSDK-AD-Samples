...
This example lists Service Principals through this API's endpoint - [List Service Principals](https://docs.microsoft.com/en-us/graph/api/serviceprincipal-list?view=graph-rest-1.0&tabs=http)
...
- Create and activate your virtual environment and run `list-service-principals.py`.
