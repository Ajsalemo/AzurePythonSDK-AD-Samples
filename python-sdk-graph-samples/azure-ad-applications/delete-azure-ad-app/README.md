...
This example deletes an Azure AD application through this API's endpoint - [Delete an Azure AD application](https://docs.microsoft.com/en-us/graph/api/application-delete?view=graph-rest-1.0&tabs=http)
...
- Create and activate your virtual environment and run `delete-azure-ad-app.py`.
