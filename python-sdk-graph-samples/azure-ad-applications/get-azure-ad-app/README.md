...
This example gets an Azure AD application through this API's endpoint - [Create Application](https://docs.microsoft.com/en-us/graph/api/application-get?view=graph-rest-1.0&tabs=http)
...
- Create and activate your virtual environment and run `get-azure-ad-app.py`.
